...
#define IMGUI_DEMO_MARKER(section)  do { if (GImGuiDemoMarkerCallback) GImGuiDemoMarkerCallback("im_anim_demo", __LINE__, section, GImGuiDemoMarkerCallbackUserData); } while (0)
#else
